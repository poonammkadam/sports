            ...
            <form method="POST" autocomplete="off" action="/profile/update">
                ...
                <div class="form-row">
                    <div class="form-group col-md-5">
                        ...
                        <input required type="email" name="email" value="{{$objProfile->email}}" class="form-control"
                               id="inputEmail4" placeholder="Email">
                    </div>
                    <div class="col-md-2"></div>
                    <div class="form-group col-md-5">
                        <label for="inputAddress">Local Name</label>
                        <input required type="text" name="local_name" value="{{$objProfile->name}}" class="form-control"
                ...
                <div class="form-row">
                    <div class="form-group col-md-5">
                        ...
                        <input required type="text" name="first_name" class="form-control" id="inputAddress"
                               placeholder="">
                    </div>
                    <div class="col-md-2"></div>
                    <div class="form-group col-md-5">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <input required type="text" class="form-control" name="passport_no" id="inputAddress2"
