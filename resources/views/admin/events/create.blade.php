        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                        ...
                        <form method="POST" enctype="multipart/form-data" autocomplete="off"
                            ...
                            <div id="dynamic_field">
                                <div class="addedSection">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label for="category_fee0">Early Bird Fee</label><input type="text" required
                                                                                                    id="category_fee0"
                                                                                                    name="category[0][fee][early][earlybird]"
                                                                                                    class="form-control item_category">
                                        </div>
                                        <div class="col-md-3">
                                            <label for="category_fee0">Early Bird Ticket Quantity</label><input
                                                type="text" required id="category_fee0"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="category_fee0">General Fee</label><input type="text" required
                                                                                                 id="category_fee0"
                                                                                                 name="category[0][fee][normal][normalfee]"
                                                                                                 class="form-control item_category">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="category_fee0">General Ticket Quantity</label><input type="text"
                                                                                                             required
                                                                                                             id="category_fee0"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <label for="category_fee0">Late Fee</label><input type="text" required
                                                                                              id="category_fee0"
                                                                                              name="category[0][fee][late][latefee]"
                                                                                              class="form-control item_category">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="category_fee0">Late Ticket Quantity</label><input type="text"
                                                                                                          required
                                                                                                          id="category_fee0"
                    ...
                    <div class="form-group row">
                        <label for="register_expire_date" class="col-md-4 col-form-label text-md-right">Registration
                            Start Date</label>
                        <div class="col-md-6">
                            <input required type="datetime-local" class="form-control" id="register_expire_date"
                                   name="register_start_date" placeholder="">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="register_expire_date" class="col-md-4 col-form-label text-md-right">Registration End
                            Date</label>
                        <div class="col-md-6">
                            <input required type="datetime-local" class="form-control" id="register_expire_date"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input required type="datetime-local" class="form-control" id="eventdate" name="eventdate"
                                   placeholder="">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <label for="description" class="col-md-2 col-form-label text-md-right">Is pickup and drop
                            available</label>
                    ...
                    <div class="form-group row" id="pickup_drop_available" style="display: none">
                        <label for="pickup_drop" class="col-md-2 col-form-label text-md-right">Is pickup and drop
                            Location</label>
                        <div class="col-md-10">
