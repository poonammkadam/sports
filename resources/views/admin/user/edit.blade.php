                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" autocomplete="off" action="{{url('/admin/user/update/'.$objUser->id)}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{$objUser->name}}" required autocomplete="name" autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{$objUser->email}}" required autocomplete="email">
