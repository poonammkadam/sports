...
class UserController extends Controller
{
    ...
    public function getProfile()
    {
        ...
        if ($objProfile->registration_status) {
            ...
            return view('layouts.view.profile', [
                ...
                'objUserProfilEvents' => $objUserProfileEvents,
    ...
    {
        $arrObjEvents = Events::whereDateTime('event_date', '>=', Carbon::today())->get();
    ...
    public function eventCreate($id)
    {
        ...
        return redirect('registration')->with('alert',
            'Sorry!!! you cant register for event first you need complete your profile');
    }
}
